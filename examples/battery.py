...
def draw_battery():
    ...
    text_width = display.measure_text(text, scale=1)  # Measure the actual width of the text
    x_position = (WIDTH - text_width) // 2  # Recalculate horizontal center based on measured width
    display.text(text, x_position, int(HEIGHT * 0.2), WIDTH, 1)
